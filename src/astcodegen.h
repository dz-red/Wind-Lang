 ...
 *
 * Срез 3d (loop..in): loop v in <список> — итерация по спискам (for + _wl_get).
 *
 * НЕ покрыто (следующие срезы): dict, loop по массивам/dict, try/catch,
 * http.serve, json/file, импорт.
 *
